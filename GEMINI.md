...
*   **Title Bar Linter Wrapper**: Wrap the template definition inside `shared.liquid` in a `<div class="layout">` container *within* the template block. This satisfies file-based compiler checks without polluting the outer namespace.
