...
*   **Full Layout Stacking**: Use a vertical stacking hierarchy for the `full` layout: center the radar SVG on top (maximum height 260px), stack the title and status badge horizontally below, and lay out metrics/schedule lists in horizontal grid columns at the bottom.
